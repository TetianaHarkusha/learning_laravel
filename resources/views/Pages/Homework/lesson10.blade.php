...
@section('content')
    ...
    <ol>
        ...
        <li>Отримайте якогось користувача разом з його профілем. </li>
        <li>Отримайте всіх користувачів разом з їхніми профілями, передайте їх у виставу 
            та виведіть на екран у вигляді HTML таблиці.</li>
        <li>Зв'яжіть таблиці з користувачами та профілями ставленням додовжин.</li>
        <li>Отримайте всі профілі разом з їхніми користувачами. Виведіть їх у поданні у вигляді HTML таблиці.</li>
        <li>Зробіть такі таблиці:<br>
