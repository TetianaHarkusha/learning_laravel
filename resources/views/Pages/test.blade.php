    ...
    <div class="col-6">
        ...
        <form action="{{ route('test.form') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="num1" type="text" class="form-control" id="num1" aria-describedby="num1Help" value="{{old('num1') ?? $num1 ?? ''}}">
                <div id="num1Help" class="form-text">Enter the first number.</div>
            </div>
            <div class="mb-3">
                <label for="num2" class="form-label">Число 2:</label>
                <input name="num2" type="text" class="form-control" id="num2" aria-describedby="num2Help" value="{{old('num2') ?? $num2 ?? ''}}">
                <div id="num2Help" class="form-text">Enter the second number.</div>
            </div>
            <div class="mb-3">
                <label for="num1" class="form-label">Число 3:</label>
                <input name="num3" type="text" class="form-control" id="num3" aria-describedby="num3Help" value="{{old('num3') ?? $num3 ?? ''}}">
